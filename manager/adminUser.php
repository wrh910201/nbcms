...
if('add' == $opera)
{
    if(!checkPurview(0x1000000, $_SESSION['purview']))
    {
...
if('edit' == $opera)
{
    if(!checkPurview(0x4000000, $_SESSION['purview']))
    {
        showSystemMessage('权限不足', array());
        exit;
    }
...
if('list' == $act)
{
    if(!checkPurview(0x2000000, $_SESSION['purview']))
    {
        showSystemMessage('权限不足', array());
        exit;
    }
...
if('delete' == $act)
{
    if(!checkPurview(0x8000000, $_SESSION['purview']))
    {
        showSystemMessage('权限不足', array());
        exit;
    }
